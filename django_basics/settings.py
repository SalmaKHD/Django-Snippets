...
SECRET_KEY = 'django-insecure-^&4rns%1eju6-v*ooc5x$d&a%m@aqnphn*1dmj22zx7f=he__e'
...
REST_FRAMEWORK = {
    ...
    'PAGE_SIZE': 2,  # Show 20 movies per page,
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'context_processors.menu_categories.menu_categories'
            ],
        },
    },
]
...
DATABASES = {
    'default': {
        ...
        'NAME': os.getenv('POSTGRES_DB', 'movie_store'),
...
# Fallback to SQLite for local non-Docker run
